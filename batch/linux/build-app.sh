...
echo "==================================================="
echo "Building Player by HEIMLICH for Linux"
echo "==================================================="
...
if ! command -v qmake &> /dev/null; then
    echo "[ERROR] Qt not found. Please install Qt for Linux."
    echo "You can install it via:"
    echo "Ubuntu/Debian: sudo apt-get install qt6-base-dev qt6-qml-dev"
...
cd batch/linux
echo "Build script completed from batch/linux directory!" 